...
- pricing_grounded: true если цена обоснована источником (реальная сделка, каталог, бридж);
                    false если цена явно из общих рыночных представлений или галлюцинация
